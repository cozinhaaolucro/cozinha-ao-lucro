-- SCRIPT COMPLETO E DEFINITIVO V3 - COZINHA AO LUCRO
-- Correção: Garante que order_number seja TEXTO para aceitar "#1234"
-- Pode ser executado múltiplas vezes.

-- 1. CONFIGURAÇÃO INICIAL
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- 2. TABELAS PRINCIPAIS (Criação se não existirem)
...
CREATE TABLE IF NOT EXISTS public.orders (
  ...
  order_number TEXT, -- Deve ser TEXT
...
-- 3. CORREÇÕES ESTRUTURAIS (ALTER TABLE)
...
-- CORREÇÃO CRÍTICA V3: Converter order_number para TEXT e remover NOT NULL
ALTER TABLE public.orders ALTER COLUMN order_number TYPE TEXT;
