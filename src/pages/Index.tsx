...
import { CheckCircle, Star, Shield, Clock, TrendingUp, DollarSign, Users, Award, ArrowRight } from 'lucide-react';
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden font-sans selection:bg-primary selection:text-primary-foreground">
      ...
      {/* Seção Herói */}
      <section ref={heroRef} className={`relative min-h-screen flex items-center justify-center hero-gradient overflow-hidden transition-all duration-1000 pt-20 md:pt-24 ${visibleElements.has('hero-bg') ? 'opacity-100' : 'opacity-0'}`}>
        {/* Formas Morphing */}
        ...
        <div className="container-max relative z-10 text-center text-white px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 ref={titleRef} className={`text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight transition-all duration-700 transform ${visibleElements.has('title') ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-6 scale-95'}`}>
              ...
              <span className="block text-primary-glow mt-2">
                Máquina de Lucros
              </span>
            </h1>
              ...
              <div className="relative">
                <a href="https://pay.kiwify.com.br/TV099tr" target="_blank" rel="noopener noreferrer" className="block">
                  <img
                    ...
                    alt="Logo Cozinha ao Lucro - Método para vender doces e salgados"
      ...
      <section className="section-padding bg-background relative overflow-hidden">
        <div className="container-max relative z-10">
          <div className="text-center mb-12">
            <Badge className="bg-primary/10 text-primary mb-4 hover:bg-primary/20 border-primary/20">DESCUBRA SEU POTENCIAL</Badge>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <a href="https://pay.kiwify.com.br/TV099tr" target="_blank" rel="noopener noreferrer">
                <img src="/images/ebook_da_cozinha_ao_lucro_20251117_062259.png" alt="Capa do Ebook Cozinha ao Lucro em 3D" className="w-full max-w-md mx-auto shadow-elegant rounded-lg h-[300px] object-cover cursor-pointer transform hover:scale-105 hover:-rotate-2 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20" />
              </a>
            </div>
      ...
      {/* Seção de Calculadora (NOVA) */}
      <section className="section-padding bg-background relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-muted/30 to-transparent"></div>
        <div className="container-max relative z-10">
          <div className="text-center mb-12">
            <Badge className="bg-green-500 text-white mb-4 hover:bg-green-600">NOVIDADE EXCLUSIVA</Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
      ...
      {/* Seção de Benefícios */}
      <section id="benefícios" className="section-padding bg-gradient-to-br from-accent/30 to-secondary-light/20 animated-gradient-bg scroll-mt-20">
        <div className="container-max">
          <RevealOnScroll>
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
            ...
            {[{
              ...
              <Tilt key={index} options={{ max: 10, scale: 1.02, speed: 400 }} className="h-full">
                <RevealOnScroll delay={index * 0.1} className="h-full">
                  <Card className="shadow-card hover:shadow-elegant transition-all duration-300 text-center group cursor-pointer border-l-4 border-l-primary hover:border-l-primary-glow h-full bg-card/50 backdrop-blur-sm">
      ...
      <section id="depoimentos" className="section-padding scroll-mt-20 bg-background">
        <div className="container-max">
          <RevealOnScroll>
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[{
              ...
              <RevealOnScroll key={index} delay={index * 0.1} className="h-full">
                <Card className="shadow-card hover:shadow-elegant transition-smooth h-full border-primary/10">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <RevealOnScroll direction="right">
              <div className="text-center lg:text-left">
                <a href="https://pay.kiwify.com.br/TV099tr" target="_blank" rel="noopener noreferrer">
                  <img src="/images/ebook_receitas_que_vendem_20251117_062322.png" alt="Capa do Ebook Bônus Receitas que Vendem" className="w-full max-w-sm mx-auto lg:mx-0 shadow-elegant rounded-lg mb-6 h-[216px] object-cover cursor-pointer transform hover:scale-110 hover:rotate-1 transition-all duration-500 hover:shadow-2xl hover:shadow-secondary/20 group-hover:animate-pulse" />
                </a>
              </div>
            </RevealOnScroll>
              ...
              <div>
                ...
                <div className="space-y-4 mb-8">
                  {[{
                    ...
                    <div key={index} className="flex items-center gap-4 p-4 bg-white/50 rounded-lg hover:bg-white/80 transition-colors">
      ...
      <section id="oferta-final" className="section-padding bg-gradient-to-br from-primary/5 to-secondary/5">
        <div className="container-max">
          ...
          <RevealOnScroll delay={0.2}>
            <Card className="max-w-4xl mx-auto shadow-glow border-2 border-primary/20 overflow-hidden">
              <CardContent className="p-8 md:p-12 bg-card/50 backdrop-blur-sm">
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  <div className="text-center">
                    <div className="relative inline-block">
                      <img src="/images/ebook_da_cozinha_ao_lucro_20251117_062259.png" alt="Kit Ebook Cozinha ao Lucro" className="w-48 mx-auto mb-4 shadow-elegant rounded-lg h-[130px] object-cover transform hover:scale-110 hover:-rotate-3 transition-all duration-500 hover:shadow-xl hover:shadow-primary/30 relative z-10" />
                      <img src="/images/ebook_receitas_que_vendem_20251117_062322.png" alt="Bônus Ebook Receitas que Vendem" className="w-32 absolute -bottom-4 -right-12 shadow-elegant rounded-lg h-[100px] object-cover transform hover:scale-125 hover:rotate-6 transition-all duration-500 hover:shadow-xl hover:shadow-secondary/30 z-20" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="text-center lg:text-left">
                      ...
                      <Button className="cta-button w-full text-xl py-8 mb-4 shadow-lg hover:shadow-primary/50 transition-all transform hover:scale-105" onClick={() => window.open('https://pay.kiwify.com.br/TV099tr', '_blank')}>
                        QUERO LUCRAR AGORA!
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {[{
                ...
                <RevealOnScroll key={index} delay={index * 0.05}>
                  <AccordionItem value={`item-${index}`} className="bg-white shadow-card rounded-lg px-6 border-none">
      ...
      <footer className="bg-foreground text-background py-12">
        <div className="container-max text-center">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="font-bold text-2xl text-white">Cozinha ao Lucro</span>
          </div>
          ...
          <div className="flex justify-center gap-6 text-sm text-white/50 mb-8">
