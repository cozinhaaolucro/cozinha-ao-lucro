            ...
            <div className="container-max relative z-10">
                <RevealOnScroll>
                    <div className="text-center mb-12">
                        <Badge className="bg-primary/10 text-[hsl(41,53%,55%)] mb-4 hover:bg-primary/20 border-primary/20 px-4 py-1 text-sm font-bold relative overflow-hidden effect-shine shine-slow">
