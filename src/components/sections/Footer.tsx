        ...
        <footer className="bg-footer text-footer-foreground pb-6 pt-8 relative mt-4">
            ...
            <div className="max-w-sm mx-auto text-center relative px-6">
                <div className="flex flex-col items-center">
                    ...
                    <div className="flex justify-center gap-6 text-xs text-footer-foreground/70 mb-3">
                        <a href="#" className="hover:text-footer-foreground transition-colors duration-300">Termos de Uso</a>
                        <a href="#" className="hover:text-footer-foreground transition-colors duration-300">Privacidade</a>
                        <a href="#" className="hover:text-footer-foreground transition-colors duration-300">Contato</a>
                    </div>
                    <div className="text-footer-foreground/50 text-xs">
