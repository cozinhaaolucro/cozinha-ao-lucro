            ...
            <div className="container-max mobile-container relative z-10 text-center">
                <RevealOnScroll>
                    <div className="max-w-4xl mx-auto space-y-8 mb-16">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary font-medium text-sm animate-fade-in border border-primary/20 backdrop-blur-sm">
                        ...
                        <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
                            Controle custos, acerte no preço e saiba exatamente quanto você lucra em cada venda.
                            <span className="block mt-2 text-foreground/80 font-medium">Tudo isso em uma plataforma linda e fácil de usar.</span>
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                            ...
                            <LeadFormDialog>
                                <Button
                                    size="lg"
                                    variant="outline"
                                    className="h-auto px-8 py-8 w-full sm:w-auto text-lg border-2 hover:bg-muted/50 transition-all font-medium"
                                >
                ...
                <RevealOnScroll delay={0.3}>
                    <div className="relative mx-auto max-w-6xl perspective-1000 mt-12 group">
