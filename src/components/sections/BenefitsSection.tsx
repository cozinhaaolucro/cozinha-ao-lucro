                    ...
                    {benefits.map((benefit, index) => (
                        <Tilt key={index} options={{ max: 10, scale: 1.02, speed: 400 }} className="h-full">
                            <RevealOnScroll delay={index * 0.1} className="h-full">
                                <Card className="bg-card/50 backdrop-blur-sm border-white/10 hover:border-primary/20 hover:shadow-elegant transition-all duration-300 text-center group cursor-pointer h-full min-h-[220px] relative overflow-hidden flex flex-col">
                                    <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                                    <CardContent className="p-6 flex flex-col items-center justify-center flex-1 h-full relative z-10">
                                        <div className="w-16 h-16 bg-primary/5 rounded-2xl flex items-center justify-center mx-auto mb-6 transition-all duration-300 group-hover:scale-110 group-hover:bg-primary/10 shadow-sm border border-primary/10 flex-shrink-0">
                                        ...
                                        <p className="text-muted-foreground leading-relaxed group-hover:text-foreground/80 transition-colors duration-300 flex-grow">{benefit.desc}</p>
                                    </CardContent>
                                </Card>
                            </RevealOnScroll>
                        </Tilt>
